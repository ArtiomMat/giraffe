...
impl TreeEvaluator {
    ...
    fn evaluate_tree(tree: &Tree) -> f32 {
        match tree {
            ...
            Tree::Tokens(_) => panic!("This is not supposed to be here"),
        }
    }
    ...
    fn detokenize(mut tokens: Vec<ExpressionToken>) -> Tree {
        ...
        //     match tokens[i] {
        //         ExpressionToken::Add => {
        //             let right_tokens = tokens.split_off(i + 1);
        //             _ = tokens.pop();
        //             return Tree::Add(
        //                 Box::new(Self::detokenize(tokens)),
        //                 Box::new(Self::detokenize(right_tokens)),
        //             );
        //         }
        //         ExpressionToken::Subtract => {
        //             let right_tokens = tokens.split_off(i + 1);
        //             _ = tokens.pop();
